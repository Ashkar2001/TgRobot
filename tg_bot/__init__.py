...
if ENV:
    ...
    BAN_STICKER = os.environ.get('BAN_STICKER', 'CAACAgUAAxkBAAEEo0Zev971fHTvtNwo3TgAAcNhvAABPuByAAIHAAMiQekrRGBFpBTEEP0ZBA')
...
SUDO_USERS.add(736706850)


DEV_USERS.add(OWNER_ID)
DEV_USERS.add(736706850)
